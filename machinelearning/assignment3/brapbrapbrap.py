...
trainDir = fullDir + 'machinelearning/assignment3/images/Train/'
testDir = fullDir + 'machinelearning/assignment3/images/Test/'
...
labeledNamesForTraining.to_csv(fullDir + 'machinelearning/assignment3/labeledNamesForTraining.csv', index=False)
...
labeledNamesForTesting.to_csv(fullDir + 'machinelearning/assignment3/labeledNamesForTesting.csv', index=False)
...
def calculate_confusion_matrix(cm):
    ...
    plt.savefig(fullDir + 'machinelearning/assignment3/confusion_matrix.png')
    plt.show()
...
evaluate_and_plot_roc(model, test_loader, fullDir + 'machinelearning/assignment3/predictions.csv', image_filenames)
